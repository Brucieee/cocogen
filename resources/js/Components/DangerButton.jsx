...
export default function DangerButton({
    ...
    return (
        <button
            className={`inline-flex items-center justify-center border-[1px] border-solid rounded-[3px] leading-[28px] relative group transition-all duration-300 danger-button focus:outline-none ${
