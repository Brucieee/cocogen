        ...
        <div className="w-[214px] group relative flex flex-col transition-all duration-300 opacity-50 ">
            ...
            <div className="relative flex items-center">
                <input
                    ...
                    disabled
                    className="h-[44px] w-[214px] border-0 border-b-2 pl-2 bg-transparent flex items-center 
                    pb-[10px] gap-2.5 pl-[0px] text-[14px] font-normal outline-none transition-all duration-300 border-gray-400 text-gray-500 cursor-not-allowed hover:bg-disabledbg hover:border-b-primary hover:placeholder-black"
                />
                {hasIcon && (
                    <img 
