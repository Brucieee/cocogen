...
const ReminderIncorrect = () => {
  return (
    <div className="flex p-[10px_20px] items-start gap-[20px] w-[705px] h-[68px] bg-[#F2F2F2] rounded-lg">
      {/* Warning Icon with Background */}
      <div className="flex w-[26px] h-[26px] p-[3px] justify-center items-center rounded-[16px] bg-[#DD0707]">
        <img src="/icons/Icon-WarningCircle.svg" alt="Warning" className="w-[20px] h-[20px]" />
      </div>
